...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Quantidade de clicks", value: "qtd"},
  ...
  let a = await api.get(`/ura/${this.opcao}/${this.d1}/${this.d2}`)
  console.log(a.data.dados)   
  this.dados = a.data.dados;
    ...
    saveCSV() {
      ...
      //================================================================
       let csvFile = `"Ramal";"Hora inicial";"Hora final";"Duração";"Duração de espera";"Fila";"Telefone";"Status De Desligamento"\n`;
      this.dados.forEach((a) => {
        csvFile += `"${a.callerid2}";"${a.iniciochamada}";"${a.dataHora}";"${a.talktime}";"${a.holdtime}";"${a.fila}";"${a.callerid1}";"${a.reason}"\n`;
      });

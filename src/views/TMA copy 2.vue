<template>
  <div class="limiter">
    ...
    <v-card class="filtrorelatorios">
      ...
      <input type="date" class="datest" />

      <!--Saída do Período da API-->
      <input type="date" class="datest" />
      <v-menu offset-y>
        <template v-slot:activator="{ on, attrs }">
          <v-btn color="primary" dark v-bind="attrs" v-on="on" class="botaoA">
            Agente
          </v-btn>
        </template>
        <v-list>
      ...
      <v-btn  dark v-bind="attrs" v-on="on" class="botaoSair" >voltar</v-btn>
</router-link>
    </v-card>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Ligações atendidas", value: "LigacoesAtendidas" },
        { text: "Duração", value: "duracao" },
        { text: "TMA", value: "tempoMedio" },
        { text: "Tempo Máximo", value: "tempoMAX" },
      ],

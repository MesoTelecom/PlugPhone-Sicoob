...
export default {
  ...
  data: () => ({
    items: [
      {
        title: "Cadastro Dos Grupos",
        text: "Monitoramento dos operadores em tempo real",
        img:
          "https://images.pexels.com/photos/7658355/pexels-photo-7658355.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
        url: "/cadastrogrupo",
      },
    ],

...
//console.log(calldate, channel, clid, cnam, cnum, dcontext, did, disposition, dst, dstchannel, duration, lastapp, lastdata, outbound_cnam, outbound_cnum, recordingfile, src, uniqueid)
 ...
 this.dados = ligacoes
    ...
    saveCSV() {
      ...
      //================================================================
       let csvFile = `"Tempo";"Uniqueid";"Solicitante";"Teleatendente";"Fila";"Duração em seg";"Espera em seg";"Tronco";"Status"\n`;
      this.dados.forEach((a) => {
        csvFile += `"${a.datahora}";"${a.uniqueid}";"${a.solicitante}";"${a.teleatendente}";"${a.fila}";"${a.duracao}";"${a.holdtime}";"${a.tronco}";"${a.estado}"\n`;
      });

              ...
              <div id="callcenter-controles">
                ...
                <h1>
                  <img src="../../src/assets/agent.png" style="width: 34px" /><b
                    style="color: black"
                  >
                    Agente: {{ $store.state.usuario.usuario }} | Ramal:
                ...
                <v-dialog v-model="dialogTransfer" max-width="500px">
                  <template v-slot:activator="{ on, attrs }">
                    <v-btn v-bind="attrs" v-on="on"> Transferência </v-btn>
                  </template>
                  ...
                  <v-card>
                    ...
                    <v-card-actions>
                      ...
                      <v-btn
                        color="blue darken-1"
                        text
                        @click="transferir(), (dialogTransfer = false)"
                      >
                        Transferir
                      </v-btn>
                    </v-card-actions>
...
export default {
  ...
  methods: {
    ...
    sair: async function () {
      ...
      let c = await api.get(
        `/logsdeslogar/${ramalnum}/${pindeslogar}/${fila}`
      );
      console.log(c)
      let update = await api.get(

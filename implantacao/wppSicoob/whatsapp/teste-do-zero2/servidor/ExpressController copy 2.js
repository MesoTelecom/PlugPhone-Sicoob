...
const { send, sendImage, sendVideo, sendAudio, sendDocument, sendTemplate, download, test, getImage } = require('/whatsapp/webhook/methods.js');
...
class ExpressController {
  ...
  initializeRoutes() {
    ...
    const fileFilter = (req, file, cb) => {
      const allowedTypes = /audio\/mpeg|audio\/wav/; // Tipos de áudio permitidos
    ...
    this.expressAppWrapper.post('/upload',  async (req, res) => {

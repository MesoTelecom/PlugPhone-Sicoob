...
let sendImage = async function (to, id, res) {
    ...
    try {
        ...
        let qry = `insert into meso_mensagens_solicitante (telefone,nome,agent,wpnumber,mensagem, type) values ('${to}','Ian-Sicoob','Ian-Sicoob','553198720162','${id}','image');`
        ////console.log('furia berserk',qry)
        executaQry(qry)
...
let sendVideo = async function (to, id, link, res) {
    ...
    try {
        ...
        let qry = `insert into meso_mensagens_solicitante (telefone,nome,agent,wpnumber,mensagem, type) values ('55${to}','Ian-Sicoob','Ian-Sicoob','553198720162','${body}','video');`
        ////console.log('furia berserk',qry)
        executaQry(qry)
...
let sendAudio = async function (to, id, res) {
    ...
    try {
        ...
        let qry = `insert into meso_mensagens_solicitante (telefone,agent,wpnumber,mensagem,tipo) values ('55${to}','Ian-Sicoob','553198720162','${id}','audio');`
        ////console.log('furia berserk',qry)
        executaQry(qry)
...
let sendDocument = async (to, id, filename, res) => {
    ...
    try {
        ...
        let qry = `insert into meso_mensagens_solicitante (telefone,nome,agent,wpnumber,mensagem, type) values ('55${to}','Ian-Sicoob','Ian-Sicoob','553198720162','${body}','document');`
        ////console.log('furia berserk',qry)
        executaQry(qry)

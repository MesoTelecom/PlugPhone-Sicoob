<template>
    <div class="limiter">
		...
		<div class="container-table100">
			...
			<div class="wrap-table100">
				<div class = "logo">
					<a href="#">
						<img src="../assets/plugbranco3.png" width="250" height="250" alt="" />   
					</a>
					<p>Cadastrar ramal nas filas de atendimento</p> 
  ...
  >
    <v-text-field
      v-model="insereItem.ramal_fisico"
      :counter="10"
      :rules="nameRules"
      label="Ramal Físico"
      required
    ...
    <v-text-field
      v-model="insereItem.ramal_virtual"
      :rules="nameRules"
      label="Ramal Virtual"
      required
    ></v-text-field>
    ...
    >
      Cadastrar
		...
		<router-link to="/listaramal"><v-btn
      color="blue"
      @click="nada"
    >
      Listar
...
export default {
  ...
  methods: {
    ...
    async save() {
   //inclui
	let res = await api.post("/insereramal",this.insereItem);
    if (res.data.msg=="erro") {
    window.alert("Ocorreu um erro - code 2!");
	} else {
    this.desserts.push(this.insereItem);
	window.alert("Ramal vinculado com sucesso!");
    }

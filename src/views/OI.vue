...
export default {
  ...
  methods: {
    ...
    exibir: async function () {
      ...
      let deletalheSainte = await api.get(
        `/detalhessainte/${this.d1}/${this.d2}/${grupo}`
      );
      console.log("oi1", `/detalhessainte/${this.d1}/${this.d2}/${grupo}`);
      console.log("oi2", deletalheSainte.data.dados);
      this.dados = deletalheSainte.data.dados;
    },
    ...
    saveCSV() {
      ...
      this.dados.forEach((a) => {
        csvFile += `"${a.teleatendente}";"${a.datahora}";"${a.duracao}";"${a.holdtime}";"${a.fila}";"${a.solicitante}";"${a.razao}";"${a.estado}"\n`;
      });

<template>
  <div class="limiter">
    ...
    <v-data-table :headers="headers" :items="desserts" sort-by="calories" class="elevation-1">
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>PlugPhone Scripts</v-toolbar-title>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "Roteiro de chamada", value: "texto" },
  ...
  methods: {
    async initialize() {
      let res = await api.get("/listascripts");
    ...
    async deleteItemConfirm() {
      ...
      let res = await api.get("/scriptstira/" + this.editedItem.id);
      //console.log(res);
    ...
    async save() {
      ...
      if (this.editedIndex > -1) {
        //edita
        res = await api.post("/scriptsaltera", this.editedItem);
        if (res.data.msg == "erro") {
        ...
        //inclui
        res = await api.post("/inserescripts", this.editedItem);
        if (res.data.msg == "erro") {

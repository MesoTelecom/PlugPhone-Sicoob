<template>
  <div class="limiter">
    ...
    <v-card class="filtrorelatorios">
      ...
      <v-btn dark href="/relatorioscampanha" class="botaoSair">voltar</v-btn>

      <v-btn dark class="botaoexportar" @click="saveCSV()">Exportar CSV</v-btn>
    </v-card>
    <br>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Número", value: "telefone" },
        { text: "Nome", value: "nome" },
        { text: "ID", value: "id" },
        { text: "Data da ultiama msg", value: "datahora" },
        { text: "Atendente", value: "usuario" },
        { text: "PA", value: "id_agencia" },
        { text: "Estado", value: "estado" },

        { text: "Última Mensagem", value: "ultimamsg" },
  ...
  methods: {
    ...
    exibir: async function () {
      ...
      let a = await apiWP.get(`/detalhecampanha/${this.d1}/${this.d2}/${this.grupo}`)
      let ver = a.data.dados
      console.log('ver', ver)

      let numero, nome, id, datahora, usuario, id_agencia, ultimamsg, estado, campanha, telefone
    ...
    saveCSV() {
      ...
      this.filename = "PlugPhone Detalhes de Campanha";
      //================================================================
      let csvFile = `"Número";"Protocolo";"ID";"Data de Criação";"Canal";"Atendente";"Departamento";"Último Chamado";"Última Mensagem"\n`;
      this.dados.forEach((a) => {
        csvFile += `"${a.idMealing}";"${a.protocolo}";"${a.id}";"${a.data_criacao}";"${a.canal}";"${a.atendente}";"${a.departamento}";"${a.ultimo_chamado}";"${a.ultima_mensagem}"\n`;
      });

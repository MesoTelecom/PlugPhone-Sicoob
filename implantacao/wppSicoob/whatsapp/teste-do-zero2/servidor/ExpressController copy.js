  ...
  initializeRoutes() {
    ...
    this.expressAppWrapper.get("/buscarcontatos/:usuario/:tipo", async (req, res, next) => {
      ...
      if (tipo === 'Analista') {
        ...
        qry = `select distinct m.credor as nome, m.Telefone, m.processo from meso_mealing as m inner join meso_oportunidade as o on (m.idMealing = o.idMealing) where o.estado = 'aprovado';`
      }

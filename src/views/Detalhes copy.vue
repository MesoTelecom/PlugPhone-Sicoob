     ...
     Consultar
      ...
      <v-menu offset-y>
        <template v-slot:activator="{  }">
          <v-btn color="primary" dark   class="botaoA">
            Agente
          </v-btn>
        </template>
        <v-list>
          <v-list-item v-for="(agent, index) in Agentes" :key="index">
            <v-list-item-title>{{ agent.text }}</v-list-item-title>
          </v-list-item>
        </v-list>
      </v-menu>
      <v-menu offset-y>
      ...
      <v-menu offset-y>
        ...
        <v-list>
          <v-list-item v-for="(status, index) in estado" :key="index">
            <v-list-item-title>{{ status.text }}</v-list-item-title>
          </v-list-item>
        </v-list>
      </v-menu><router-link to="./relatoriosprincipais" class="linkp">
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Nome do Agente", value: "membername" },
        { text: "Hora inicial", value: "InicioChamada" },
        { text: "Hora final", value: "dataHora" },
        { text: "Duração", value: "talktime" },
        { text: "Duração Espera", value: "holdtime" },
        { text: "Fila", value: "fila" },
        { text: "Tipo", value: "" },
        { text: "Telefone", value: "callerid1" },
        { text: "Transferência", value: "appname" },
  ...
  let a = await api.get(`/detalhesligacoes/${this.d1}/${this.d2}`)

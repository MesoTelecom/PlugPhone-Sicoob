<template>
  <div class="limiter">
    ...
    <v-data-table :search="search" :headers="headers" :items="desserts" sort-by="calories" class="elevation-1">
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>Ramais PlugPhone</v-toolbar-title>
                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="6" md="12">
                      <v-text-field v-model="editedItem.ramal_fisico" label="Físico"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="12">
                      <v-text-field v-model="editedItem.ramal_virtual" label="Virtual"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="12">
                      <v-text-field style="width: 100% !important;" v-model="editedItem.fila"
                        label="Fila"></v-text-field>
                    </v-col>
                    <v-col class="d-flex" cols="12" sm="6">
                      <v-select :items="pegaGrupo" v-model="selectedValue" label="Outlined style" outlined></v-select>
                    </v-col>
                  </v-row>
                </v-container>
              </v-card-text>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "Ramal virtual", value: "ramal_virtual" },
      { text: "Fila de atendimento", value: "fila" },
      { text: "Grupos", value: "grupo" },
  ...
  computed: {
    formTitle() {
      return this.editedIndex === -1 ? "Novo Ramal" : "Editar Fila";
    },
  },
  ...
  methods: {
    async initialize() {
      let res = await api.get("/listaramais");
    ...
    async deleteItemConfirm() {
      ...
      let res = await api.get("/ramaltira/" + this.editedItem.id);
      console.log(res);
    ...
    async save() {
      ...
      if (this.editedIndex > -1) {
        //edita
        res = await api.post("/ramalaltera", this.editedItem);
        if (res.data.msg == "erro") {
        ...
        //inclui
        res = await api.post("/insereramal", this.editedItem);
        if (res.data.msg == "erro") {

<template>
  <div class="limiter">
    ...
    <v-card-title class="cardtitulo">
      <v-text-field v-model="search" append-icon="mdi-magnify" label="Digite seu ramal de vendedor" single-line
            ...
            <v-card>
              ...
              <v-card-text>
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="6" md="12">
                      <v-text-field v-model="editedItem.teleatendente" label="Numero de teleatendente"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="12">
                      <v-text-field v-model="editedItem.solicitante" label="Editar de solicitante"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="12"> </v-col>
                  </v-row>
                </v-container>

<template>
  <div class="limiter">
    <v-toolbar color="rgba(4, 81, 132, 0.85)" dark flat style="
        height: 104px;
        border-radius: 0%;
        background-color: rgba(4, 81, 132, 0.85);
        border-color: rgba(4, 81, 132, 0.85);
      ">
      <img src="../assets/plugbranco3.png" width="138" height="138" alt="" style="margin-bottom: -3%" />
      <v-toolbar-title style="margin-bottom: -3%">Accioly PlugPhone</v-toolbar-title>
    ...
    <v-data-table :headers="headers" :items="desserts" sort-by="calories" class="elevation-1">
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>Solicitações de Estoque</v-toolbar-title>
                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="6" md="12">
                      <v-text-field v-model="editedItem.pedido" label="Edita Pedido"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="12">
                      <v-text-field v-model="editedItem.situacao" label="Editar Situação"></v-text-field>
                    </v-col>
    ...
    <v-footer color="#296b96" padless style="">
      <v-row justify="center" no-gutters>
        <v-btn v-for="link in links" :key="link" color="#296b96" text rounded class="my-2">
          {{ link }}
        </v-btn>
        <v-col class="primary py-3 text-center white--text" style="color: #296b96" id="cor"><img
            src="../assets/plugbranco3.png" width="50" height="50" alt="" style="margin-bottom: -1%" />
          {{ new Date().getFullYear() }} —
          <strong style="font-size: 19px">PlugPhone</strong>
        </v-col>
      </v-row>
    </v-footer>
  </div>
...
export default {
  ...
  methods: {
    async initialize() {
      let res = await api.get("/listaaccioly");
    ...
    click2call: async function () {
      let dial = await api.get("/listaaccioly");
      console.log(dial);
      this.action.push(dial.data.dados);

  ...
  <div class="limiter">
    ...
    <v-card class="filtrorelatorios">
      ...
      <input type="date" class="datest" v-model="d2" required/>
       <router-link to="./detalhe" class="linkp">
      <v-btn
      class="botaoA"
    >
     Atendidas
   ...
   <router-link to="./detalheaband" class="linkp">
      <v-btn  dark   class="botaoAband"  @click="exibir()" >Abandonadas</v-btn>
</router-link>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Tempo de espera", value: "holdtime" },
        { text: "Uniqueid", value: "uniqueid" },
      //  { text: "Telefonep", value: "callerid1" },
      ],
  ...
  let a = await api.get(`/relatabandon/${this.d1}/${this.d2}`)
  //console.log(`/detalhesligacoes/${this.d1}/${this.d2}`)   
  //console.log(a.data.dados)   
  this.dados = a.data.dados;
    ...
    saveCSV() {
      ...
      this.filename = "PlugPhone Detalhes Abandonadas";
      //================================================================
       let csvFile = `"Fila";"Data e Hora";"Posição";"Tempo de espera";"Uniqueid";"Fila";"Telefone";"Status De Desligamento"\n`;
      this.dados.forEach((a) => {
        csvFile += `"${a.fila}";"${a.dataHora}";"${a.position}";"${a.holdtime}";"${a.uniqueid}"\n`;
      });
    ...
    //console.log(this.d1, this.d2)
        let b = await api.get(`/binaabandonadas/${this.d1}/${this.d2}`)
        //console.log(`/detalhesligacoes/${this.d1}/${this.d2}`)   
        //console.log(a.data.dados)   
        this.listaA = b.data.dados;
          //alert(this.filename)
      this.filename = "PlugPhone Detalhes Abandonadas";
      //================================================================
       let csvFile = `"Numeros telefonicos"\n`;
      this.listaA.forEach((a) => {
        csvFile += `"${a.calleridnum}"\n`;
      });
...
.botaoA {
  background-color: #61a5e8!important;
  margin-left: 1%;
  color: white;
}
.botaoAband{
...
.botaoC {
  margin-left: 6%;
  right: 5%;
  background-color:rgb(244, 108, 17) !important;
  color: white;
}
</style>

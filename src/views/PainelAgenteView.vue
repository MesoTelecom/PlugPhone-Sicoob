  ...
  methods: {
    ...
    informacao: async function () {
      let inf = await api.get(
        `/cpfcomginfo2/${this.$store.state.usuario.ramal}/`
      );
      ...
      infor.forEach((d) => {
        //nomefila = d.descr;
        this.info.infocallerid1 = d.chamador;
        this.info.infocallerid2 = d.atendente;
...
/* eslint-disable no-unused-vars */
    ...
    hangup: async function () {
      ...
      if (this.info.infocanal1 == "" || this.info.infocanal2 == "") {
        ...
        let canal = this.info.infocanal1.substring(4);
       // console.log('Oi eu sou canal',canal)
    ...
    verificachamada: async function () {
     ...
     // console.log('Eu sou o DIOOOOOOOO ZARAWUDO', this.ligacao);

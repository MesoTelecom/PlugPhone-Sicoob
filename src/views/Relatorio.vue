...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Usuario", value: "nome_agente" },
        { text: "Ligações Recebidas", value: "LigacoesEntrante" },
        { text: "Ligações Efetuadas", value: "LigacoesSainte" },
        { text: "Tempo Total Recebidas", value: "TempoEntrante" },
        { text: "Tempo Total Efetuadas", value: "TempoSainte" },
      ],
      dados: [],
      items: [],
      items2: [],
  ...
  methods: {
    listar: async function () {
      let listar = await api.get(`/relatoriooriente`);
      let valores = listar.data.dados;
    ...
    saveCSV() {
      this.filename = "PlugPhone Atendida";
      //================================================================
      let csvFile = `"Ramal";"Usuário";"Ligações Recebidas";"Ligações Recebidas";"Ligações Efetuada";"Tempo Total Recebidas";"Tempo Total Efetuadas";\n`;
      this.dados.forEach((a) => {
        csvFile += `"${a.num_ramal}";"${a.nome_agente}";"${a.LigacoesEntrante}";"${a.LigacoesSainte}";"${a.TempoEntrante}";"${a.TempoSainte}"\n`;
      });

                ...
                <v-container>
                  <v-row>
                    ...
                    <v-col class="d-flex" cols="12" sm="12">
                      <v-select :items="pegaGrupo" v-model="editedItem.estado" label="Selecione o estado"
                        outlined></v-select>
                    </v-col>
                  </v-row>
                </v-container>
...
export default {
  ...
  data: () => ({
    selectedValue: "",
    dados: [],
    pegaGrupo: ['Ativo', 'Em Andamento', 'Finalizado', 'Inativo'],
    grupoArray: [],
    dialog: false,
    dialogDelete: false,
    grupos: null,
    ...
    items: ['Ativo', 'Em Andamento', 'Finalizado', 'Inativo'],
    headers: [
      {
        text: "Campanha",
        align: "start",
  ...
  methods: {
    async initialize() {
      ...
      let res = await apiWP.get("/listacampanha");
    ...
    async deleteItemConfirm() {
      ...
      let res = await apiWP.get("/campanhatira/" + this.editedItem.id);
      //console.log(res);
    ...
    async save() {
      ...
      if (this.editedIndex > -1) {
        ...
        res = await apiWP.post("/campanhaaltera", this.editedItem);
        if (res.data.msg == "erro") {

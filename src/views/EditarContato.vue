...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "Ultima Mensagem", value: "ultimamsg" },
      { text: "NumeroPA", value: "id_agencia" },
  ...
  methods: {
    ...
    async deleteItemConfirm() {
      ...
      let res = await apiWP.get("/contatotira/" + this.editedItem.id);
      //console.log(res);
    ...
    async save() {
      ...
      if (this.editedIndex > -1) {
        ...
        res = await apiWP.post("/contatoaltera", this.editedItem);
        if (res.data.msg == "erro") {

<template>
  <div class="limiter">
    ...
    <v-data-table :headers="headers" :items="desserts" sort-by="calories" class="elevation-1">
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>Códigos de facilidade do PlugPhone</v-toolbar-title>
                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="6" md="12">
                      <v-text-field v-model="editedItem.exten" label="N° Contexto"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="12">
                      <v-text-field v-model="editedItem.nome" label="Nome do Contexto"></v-text-field>
                    </v-col>
...
export default {
  ...
  methods: {
    async initialize() {
      let res = await api.get("/discagem");
    ...
    async deleteItemConfirm() {
      ...
      let res = await api.get("/tiradiscagem/" + this.editedItem.id);
      //console.log(res);
    ...
    async save() {
      ...
      if (this.editedIndex > -1) {
        //edita
        res = await api.post("/discagemaltera", this.editedItem);
        //console.log(res)
        if (res.data.msg == "erro") {
        ...
        //inclui
        res = await api.post("/inserediscagem", this.editedItem);
        if (res.data.msg == "erro") {

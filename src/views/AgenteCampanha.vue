...
export default {
  ...
  methods: {
    ...
    saveCSV() {
      ...
      this.filename = "PlugPhone Agentes";
      //================================================================
      let csvFile = `"Usuário";"Quantidade de Atendimentos por Agência";"TME de resposta";"Índices de Satisfação"\n`;
      this.dados.forEach((a) => {
        csvFile += `"${a.usuario}";"${a.quantidade_atendimentos_agencia}";"${a.tempo_espera}";"${a.indices_satisfacao}"\n`;
      });
